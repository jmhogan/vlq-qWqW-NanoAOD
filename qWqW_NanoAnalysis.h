...
// Mon Jun  3 16:25:15 2019 by ROOT version 6.08/05
// from TTree Events/Events
// found on file: testFile.root
//////////////////////////////////////////////////////////

#ifndef qWqW_NanoAnalysis_h
#define qWqW_NanoAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[217];   //[nGenPart]
   Float_t         GenPart_mass[217];   //[nGenPart]
   Float_t         GenPart_phi[217];   //[nGenPart]
   Float_t         GenPart_pt[217];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[217];   //[nGenPart]
   Int_t           GenPart_pdgId[217];   //[nGenPart]
   Int_t           GenPart_status[217];   //[nGenPart]
   Int_t           GenPart_statusFlags[217];   //[nGenPart]
   ...
   Int_t           Generator_id2;
   UInt_t          nGenVisTau;
   Float_t         GenVisTau_eta[6];   //[nGenVisTau]
   Float_t         GenVisTau_mass[6];   //[nGenVisTau]
   Float_t         GenVisTau_phi[6];   //[nGenVisTau]
   Float_t         GenVisTau_pt[6];   //[nGenVisTau]
   Int_t           GenVisTau_charge[6];   //[nGenVisTau]
   Int_t           GenVisTau_genPartIdxMother[6];   //[nGenVisTau]
   Int_t           GenVisTau_status[6];   //[nGenVisTau]
   Float_t         genWeight;
   ...
   UInt_t          nJet;
   Float_t         Jet_area[34];   //[nJet]
   Float_t         Jet_btagCMVA[34];   //[nJet]
   Float_t         Jet_btagCSVV2[34];   //[nJet]
   Float_t         Jet_btagDeepB[34];   //[nJet]
   Float_t         Jet_btagDeepC[34];   //[nJet]
   Float_t         Jet_btagDeepFlavB[34];   //[nJet]
   Float_t         Jet_btagDeepFlavC[34];   //[nJet]
   Float_t         Jet_chEmEF[34];   //[nJet]
   Float_t         Jet_chHEF[34];   //[nJet]
   Float_t         Jet_eta[34];   //[nJet]
   Float_t         Jet_jercCHF[34];   //[nJet]
   Float_t         Jet_jercCHPUF[34];   //[nJet]
   Float_t         Jet_mass[34];   //[nJet]
   Float_t         Jet_muEF[34];   //[nJet]
   Float_t         Jet_muonSubtrFactor[34];   //[nJet]
   Float_t         Jet_neEmEF[34];   //[nJet]
   Float_t         Jet_neHEF[34];   //[nJet]
   Float_t         Jet_phi[34];   //[nJet]
   Float_t         Jet_pt[34];   //[nJet]
   Float_t         Jet_qgl[34];   //[nJet]
   Float_t         Jet_rawFactor[34];   //[nJet]
   Float_t         Jet_bRegCorr[34];   //[nJet]
   Float_t         Jet_bRegRes[34];   //[nJet]
   Int_t           Jet_electronIdx1[34];   //[nJet]
   Int_t           Jet_electronIdx2[34];   //[nJet]
   Int_t           Jet_jetId[34];   //[nJet]
   Int_t           Jet_muonIdx1[34];   //[nJet]
   Int_t           Jet_muonIdx2[34];   //[nJet]
   Int_t           Jet_nConstituents[34];   //[nJet]
   Int_t           Jet_nElectrons[34];   //[nJet]
   Int_t           Jet_nMuons[34];   //[nJet]
   Int_t           Jet_puId[34];   //[nJet]
   Float_t         LHE_HT;
   ...
   Bool_t          GenDressedLepton_hasTauAnc[7];   //[nGenDressedLepton]
   ...
   Int_t           PV_npvsGood;
   UInt_t          nSV;
   Float_t         SV_dlen[28];   //[nSV]
   Float_t         SV_dlenSig[28];   //[nSV]
   Float_t         SV_pAngle[28];   //[nSV]
   ...
   Int_t           Jet_genJetIdx[34];   //[nJet]
   Int_t           Jet_hadronFlavour[34];   //[nJet]
   Int_t           Jet_partonFlavour[34];   //[nJet]
   ...
   UChar_t         Jet_cleanmask[34];   //[nJet]
   UChar_t         Muon_cleanmask[9];   //[nMuon]
   UChar_t         Photon_cleanmask[13];   //[nPhoton]
   UChar_t         Tau_cleanmask[8];   //[nTau]
   Float_t         SV_chi2[28];   //[nSV]
   Float_t         SV_eta[28];   //[nSV]
   Float_t         SV_mass[28];   //[nSV]
   Float_t         SV_ndof[28];   //[nSV]
   Float_t         SV_phi[28];   //[nSV]
   Float_t         SV_pt[28];   //[nSV]
   Float_t         SV_x[28];   //[nSV]
   Float_t         SV_y[28];   //[nSV]
   Float_t         SV_z[28];   //[nSV]
   ...
   //Variables describing file
   bool		  isMC;
   TString	  outputFileName;


   qWqW_NanoAnalysis(TString inputFileName, TString outputFile);
   virtual ~qWqW_NanoAnalysis();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(bool isSignal, bool isTTbar, Long64_t skipevents, Long64_t maxevents);
...
#ifdef qWqW_NanoAnalysis_cxx
qWqW_NanoAnalysis::qWqW_NanoAnalysis(TString inputFileName, TString outputFile) : fChain(0) 
{
   //isMC = outputFileName.Contains("Single");
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("testFile.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("testFile.root");
      }
...
Int_t qWqW_NanoAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t qWqW_NanoAnalysis::LoadTree(Long64_t entry)
{
...
void qWqW_NanoAnalysis::Init(TTree *tree)
{
...
Bool_t qWqW_NanoAnalysis::Notify()
{
...
void qWqW_NanoAnalysis::Show(Long64_t entry)
{
...
Int_t qWqW_NanoAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef qWqW_NanoAnalysis_cxx
